#this program exports the bit stream contained in atonce.bin to rbt file
...
# offset begin rbt section in atonce.bin in bit
begin = 37632 * 8
offset = begin
# read atonce.bin file 
atoncebin = ConstBitStream(filename='atonce.bin')

print 'Xilinx LCA atonce.lca 2018PC84'
print 'File atonce.rbt'
