#this program exports the first bit stream contained in pc286.dsg to rbt file
# python export.py > file.rbt
# offset 0x1400 - 0x0B44
...
# offset begin rbt section in pc286.dsg in bit
begin = 5120 * 8
offset = begin
# read pc286.dsg file
atoncebin = ConstBitStream(filename='pc286.dsg')

print 'Xilinx LCA pc2861.lca 2018PC84'
print 'File pc2861.rbt'
